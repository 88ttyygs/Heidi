...
bot = telebot.TeleBot('7931632630:AAE1I2yamVPRYxDgpAPW006kVWXcbWmMcQA')
admin_id = ["7164241156"]
...
def remove_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝗪𝗘 𝗔𝗥𝗘 𝗦𝗢𝗥𝗥𝗬 𝗬𝗢𝗨 𝗔𝗥𝗘 𝗡𝗢𝗧 𝗢𝗪𝗡𝗘𝗥 𝗢𝗙 𝗧𝗛𝗜𝗦 𝗕𝗢𝗧 . 𝗢𝗪𝗡𝗘𝗥 𝗜𝗦 - @rajputmodder"
...
@bot.message_handler(commands=['rajput'])
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  
            ...
            if time > 300:
                ...
                record_command_logs(user_id, '/rajput', target, port, time)
...
def welcome_start(message):
    ...
    response = f'''𝗪𝗘𝗟𝗖𝗢𝗠𝗘 {𝐮𝐬𝐞𝐫_𝐧𝐚𝐦𝐞} 𝗧𝗢 𝗠𝗬 𝗔𝗜𝗭𝗘𝗡 𝗗𝗗𝗢𝗦 ☠️ 𝗕𝗢𝗧 :-\n𝗙𝗢𝗥 𝗠𝗢𝗥𝗘 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 𝗧𝗥𝗬 𝗧𝗢 𝗥𝗨𝗡 𝗧𝗛𝗜𝗦 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 : /rajput\n'''
    bot.reply_to(message, response)
    
@bot.message_handler(commands=['owner'])
def welcome_start(message):
    user_name = message.from_user.first_name
    response = f'''@rajputmodder'''
    bot.reply_to(message, response)
